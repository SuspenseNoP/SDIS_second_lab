...
public class NewNote {
    ...
    public void init() {
        ...
        //labelAll.setText(columnNames[5]);

        labelName.setForeground(Color.WHITE);
        labelGroup.setForeground(Color.WHITE);
        labelIllnesses.setForeground(Color.WHITE);
        labelReasons.setForeground(Color.WHITE);
        labelNoReasons.setForeground(Color.WHITE);
        ...
        //JTextField textAll = new JTextField();
